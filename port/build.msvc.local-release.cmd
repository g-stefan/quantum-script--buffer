...
echo -^> local-release quantum-script-extension-buffer
...
call :cmdX xyo-cc quantum-script-extension-buffer --archive-release-sha512 --version-file=source/quantum-script-extension-buffer.version.ini
